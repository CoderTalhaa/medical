...
const panelDiscussion = [
  {
    ...
    title:
      "Leveraging Connectivity for Better Patient Outcomes in Blood and Plasma-Derived Treatments",
    description:
...
const openInnovationChallenges = [
  {
    ...
    items: [
      {
        name: "Diabetes Connectivity Challenge: EHR Integration, Interoperability, and Behavioral Engagement",
        challengeOwner: "Sanofi",
        description:
          "This challenge aims to improve patient care by integrating connected devices into electronic health records (EHR), ensuring seamless data transfer and interoperability. It also focuses on enhancing patient engagement through behavioral techniques and gamification to encourage consistent use of diabetes management tools, which has potential applications in blood sugar management and other blood-related treatments.",
      },
      {
        name: "People-Centered Technology: Adaptability and Inclusion, Personalized Social Prescription",
        challengeOwner: "Xarxa Assistencial Universitària de Manresa",
        description:
          "This challenge seeks tech companies to develop customized digital avatars that represent the experiences of individuals with health conditions, including those with blood-related disorders. These avatars will help healthcare professionals, educators, and family members understand patient needs, simulate treatment scenarios, and improve the quality of life for individuals with blood cancers or immunological conditions.",
      },
    ],
    description:

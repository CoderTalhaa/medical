...
const openInnovationChallenges = [
  {
    ...
    items: [
      {
        name: "Identification of CAD/PAD Patients Without Prior Major CV Event in Healthcare Systems",
        challengeOwner: "Sanofi",
        description:
          "This challenge seeks AI-driven solutions for early detection of Coronary Artery Disease (CAD) and Peripheral Artery Disease (PAD) patients before major cardiovascular events occur. The goal is to integrate smart decision support systems and automated alerts into healthcare systems for more proactive cardiovascular care.",
      },
      {
        name: "Behavioral Health-Driven Solutions for Habit Change in Risk Populations",
        challengeOwner: "DKV",
        description:
          "The challenge invites digital solutions that encourage habit changes, targeting populations at risk for cardiovascular diseases. Solutions should leverage AI, behavioral science (such as Cognitive Behavioral Therapy), and an engaging user experience (UX) to create lasting impacts on health outcomes, with scalability, clinical validation, and regulatory compliance in Europe.",
      },
      {
        name: "Fall Detection for Elderly People: A Preventive and Rapid Response Approach",
        challengeOwner: "Suara Cooperativa",
        description:

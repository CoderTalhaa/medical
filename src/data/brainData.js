...
const openInnovationChallenges = [
  {
    ...
    items: [
      {
        name: "Enhancing Unambiguous and Active Identification of Psychogeriatric Unit Patients",
        challengeOwner: "Consorci Hospitalari de Vic",
        description:
          "This challenge focuses on implementing biometric identification systems, such as facial recognition, to improve patient safety, minimize medication errors, streamline healthcare workflows, and enhance treatment outcomes in psychogeriatric units.",
      },
      {
        name: "Digital Solutions for Stress Management and Sleep Quality",
        challengeOwner: "Reig Jofre",
        description:
          "The goal is to develop digital tools that assess stress levels, monitor sleep quality, identify stress factors, and offer actionable solutions to improve overall health and well-being.",
      },
      {
        name: "24/7 Monitoring of Neurological Patients",
        challengeOwner: "Institute Guttman",
        description:
